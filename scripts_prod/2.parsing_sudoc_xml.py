    ...
    for url in urls_list:
        ...
        if(xml_record := xml_response.select_one('record')):
            sudoc_maps.append({
                ...
                'westlimit': extract_text_from_tags(xml_record, 'datafield[tag="123"] [code="d"]'),
                'eastlimit': extract_text_from_tags(xml_record, 'datafield[tag="123"] [code="e"]'),
                'northlimit': extract_text_from_tags(xml_record, 'datafield[tag="123"] [code="f"]'),
                'southlimit': extract_text_from_tags(xml_record, 'datafield[tag="123"] [code="g"]'),
